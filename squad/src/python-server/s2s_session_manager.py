...
from real_estate_agents.real_estate_sonic_agent import handle_request as real_estate_sonic_agent
...
class S2sSessionManager:
    ...
    async def processToolUse(self, toolName, toolUseContent):
        try:
            ...
            if toolName == "getRealEstateInfo":
                final_response = await real_estate_sonic_agent(query, self.USER_ID, self.SESSION_ID)
