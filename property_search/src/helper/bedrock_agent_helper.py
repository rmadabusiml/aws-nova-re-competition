...
class AgentsForAmazonBedrock:
    ...
    def _create_lambda_iam_role(
        ...
        if additional_function_iam_policy is not None:
            print("Adding additional IAM policy to Lambda role")
            if enable_trace:
                print(
    ...
    def create_lambda(
        ...
        print("additional_function_iam_policy", additional_function_iam_policy)
        _agent_id = self.get_agent_id_by_name(agent_name)
        if _agent_id is None:
        ...
        print("base_filename", _base_filename)
    ...
    def add_action_group_with_lambda(
        ...
        print("source_code_file", source_code_file)
